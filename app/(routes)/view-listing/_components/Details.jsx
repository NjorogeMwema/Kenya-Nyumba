...
import ListingContactForm from '@/app/_components/listing-contact-form'
...
function Details({listingDetail}) {
  return listingDetail && (
    <div className='my-6 flex gap-2 flex-col'>
      ...
      <div>
        <h2 className='font-bold text-2xl '>Reach Out to Agent</h2>
        <AgentDetail listingDetail={listingDetail} />
        <ListingContactForm listingId={listingDetail.id} />
      </div>
    </div>
  )
}
